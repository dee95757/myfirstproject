    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Edit (int id)
        {
            ...
            var pvm = new ProductEditViewModel
            {
                ...
                Suppliers = suppliers.Select(s => new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem
        ...
        public IActionResult Edit(ProductEditViewModel pvm)
        {
            ...
            {
                var suppliers = _dataContext.Suppliers.ToList();
                pvm.Suppliers = suppliers.Select(s => new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem
                { Text = s.CompanyName, Value = s.Id.ToString() }).ToList();
                return View(pvm);
            }
